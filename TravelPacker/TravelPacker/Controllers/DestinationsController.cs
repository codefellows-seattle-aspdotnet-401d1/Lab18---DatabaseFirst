...
namespace TravelPacker.Controllers
{
    public class DestinationsController : Controller
    {
        ...
        public DestinationsController(TravelPackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DestinationID,LocationName,Climate")] Destination destination)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DestinationID,LocationName,Climate")] Destination destination)
        {
